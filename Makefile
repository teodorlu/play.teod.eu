...
welcome-developer/index.html: welcome-developer/index.org
	pandoc -s --shift-heading-level-by=1 --from=org+smart -i welcome-developer/index.org -t json | ./play.clj filter resolve-links | pandoc -f json -o welcome-developer/index.html --standalone --toc -H header-default-include.html

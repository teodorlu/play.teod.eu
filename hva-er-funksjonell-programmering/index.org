...
Clojure har knallgod støtte for funksjonell programmering og knallgode utviklerverktøy for Clojure-koding i VSCode[fn:calva] og dynamiske utviklingsmiljøer[fn:clerk].

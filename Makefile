...
tool/index.html: tool/index.org
	pandoc -s --shift-heading-level-by=1 --from=org+smart -i tool/index.org -t json | ./play.clj filter resolve-links | pandoc -f json -o tool/index.html --standalone --toc -H header-default-include.html

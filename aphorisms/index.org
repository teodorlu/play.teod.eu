...
6 - Consider modeling /all possible states/ as one data structure. Less edge cases give cleaner code structure.

7 - DO - critique your documentation when "How does X work?" is asked.

8 - DON'T require hierarchy to be equal to legibility

9 - Emacs is a tool for research, and happens to also work for edititing source code

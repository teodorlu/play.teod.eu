...
list-of-work-play-failures/index.html: list-of-work-play-failures/index.org
	pandoc -s --shift-heading-level-by=1 --from=org+smart -i list-of-work-play-failures/index.org -t json | ./play.clj filter resolve-links | pandoc -f json -o list-of-work-play-failures/index.html --standalone --toc -H header-default-include.html

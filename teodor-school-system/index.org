...
Goal: encourage the belief that people can /change their circumstances for the better/.
...
6. There's tention between the "western tradition for education" and the "eastern tradition for education".
   1. Teodor's current understanding:
      1. Western education is based on /skills/ ([[https://en.wikipedia.org/wiki/Techne][techne]]) and knowledge ([[https://en.wikipedia.org/wiki/Episteme][episteme]]), eastern education is based on principles
...
9. Emotional development (trust, self-awareness, being aware of one's emotions) and "professional development" (learning skills ([[https://en.wikipedia.org/wiki/Techne][teche]]), knowledge ([[https://en.wikipedia.org/wiki/Episteme][episteme]])) go hand-in-hand.
   Learning to solve hard problems together is a way to get better both at solving hard problems, and working together.

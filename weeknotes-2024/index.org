...
After /yet another batch of structured thinking I fail to follow up/, I decide to try again.
...
And I found Clojure sort of by accident after finding Haskell in 2014 (I did a 148 slide presentation about Haskell in Norwegian in 2024, [[id:AE1427D5-AD4D-42B5-A971-E01E62D3D958][Haskell: hardt og godt]], in English something like "Learn Haskell the good, hard way").
...
On my current team, we have lots of code, and very limited shared understanding of that code.
...
Some people that /don't/ think are breaking those rules:
...
Because he seems to be a person who /on principle/ breaks rules to learn from breaking rthose rules.
...
[[id:96C0714D-743C-4BA3-83F9-214F5DEF36D1][Nikita Prokopov]] continutes to be a one man (slightly smaller bulldozer army --- but one that also cares deeply about design).

Jørgen, Ann and Viktor continue to see problems clearly, and similarly care deeply about the people they empower to solve those probelms.
...
[[id:E2AEC445-ECD1-4A09-89E9-B577EDC4B1F3][Finn Holme]] and [[id:702B0D17-E25B-4784-BF60-28965A545D30][Adrian Tofting]] for honestly, shamelessly being themselves.

...
attention-design/index.html: attention-design/index.org
	pandoc -s --shift-heading-level-by=1 --toc --from=org+smart -i attention-design/index.org -o attention-design/index.html
...
c-journal/index.html: c-journal/index.org
	pandoc -s --shift-heading-level-by=1 --toc --from=org+smart -i c-journal/index.org -o c-journal/index.html
...
git-commit-messages/index.html: git-commit-messages/index.org
	pandoc -s --shift-heading-level-by=1 --toc --from=org+smart -i git-commit-messages/index.org -o git-commit-messages/index.html

...
Funksjonell programmering er en disiplin for å programmere som gjør det enklere å skrive, forstå og endre kode.
...
React-teamet oppfordrer først til å lage React-apper i objektorientert stil (React Class Components), før de ombestemmer seg, og anbefaler folk å bruke reaktive funksjoner (React Hooks) i stedet.

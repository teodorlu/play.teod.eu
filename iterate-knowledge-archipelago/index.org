...
2. The inability to critique the hierarchy itself
3. Poor authority separation
4. Bad effects from intermixing drafts and completed stuff
5. Hard to find the good stuff
6. Hard to search --- index
7. Hard to build views
8. Hard to embed small things we'd want to share

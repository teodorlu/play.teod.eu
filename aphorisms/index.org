...
You will risk creating a [[https://en.wikipedia.org/wiki/The_Bed_of_Procrustes][Bed of Procrustes]] --- a prescriptive, lossy model that removes essential texture from reality.
...
Counter example: Denotational design (FIXME create page and link here.)

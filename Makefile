...
dynamic-index/index.html: dynamic-index/index.org
	pandoc -s --shift-heading-level-by=1 --from=org+smart -i dynamic-index/index.org -t json | ./play.clj filter resolve-links | pandoc -f json -o dynamic-index/index.html --standalone --toc -H header-default-include.html

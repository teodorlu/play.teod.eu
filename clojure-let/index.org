...
The context for this code is someone working with it.
Someone reading it.

And as someone reading it, I find this let block to be clear as daylight.
You read the code.
The code does what it says it does.
You can understand the order of the code---from top to bottom.
The function is /one thing/.
There's no way to use the implementation details of the function, because those details are /inside the function/.
...
It's let expressions and some code inside.

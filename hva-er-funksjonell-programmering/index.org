...
React-teamet oppfordret først til å lage React-apper i objektorientert stil (React Class Components), før de ombestemte seg, og anbefalte folk å bruke reaktive funksjoner (React Hooks) i stedet.

...
|        | intent.org             | wip.org                                  | dump.org |
|--------+------------------------+------------------------------------------+----------|
| Format | temporær braindump     | liste av ting å lære og ting å skrive om | ❤️‍🔥       |
| Formål | første touch / capture | andre touch / curation / categorization  | ❤️‍🔥       |

...
#+begin_verse
    ...
    it declares dependencies and binds them for use in source code. Maps to root.
    Challenge - link resolution.
        Do I need a redirect "service"? Yeah, perhaps I can use redirects.
            🤔
        I thought I needed magic to ensure outbound links went to the right place

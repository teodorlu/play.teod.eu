...
kosekode/index.html: kosekode/index.org
	pandoc -s --shift-heading-level-by=1 --toc --from=org+smart -H live.html -i kosekode/index.org -o kosekode/index.html

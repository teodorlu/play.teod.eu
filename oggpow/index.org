...
:END:
#+TITLE: OGGPOW: A flexible strategic framework
...
- A brief history of failed attempt leading up to OGGPOW
  ...
  - My experience as a civil engineer: the inability to improve the process as we go.
    - Too static
  - My experience working in a startup: everything is moving, confusion reigns.
    - Too dynamic
  - My experience working in a big organization: Diluted intent, emphasis on legibility and reproducability over value.
...
- Actionable
- Goal is specified as an outcome that's benefitical for end users.
** A Bucket of Options
...
Cohesion - One Knowledge Protocol

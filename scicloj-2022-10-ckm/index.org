...
1. Actionables --- "here's something more people should do"
2. Definitions --- "this is a name I'd like to reuse"
3. Journals --- "this is just a record"
4. Foregin references --- "pointers to content from others, possibly annotated"

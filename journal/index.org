...
Så o er oddmund, l er lars, r er richard.

Steg 1: lag en ny subkommando.
...
Den da kan vi se hva vi får inn av CLI-parse-biblioteket.

#+begin_src
$ olorm draw olr
{:cmds ("draw" "olr"), :args (), :rest-cmds (), :opts {:pool "olr"}, :dispatch ["draw"]}
#+end_src
** xx

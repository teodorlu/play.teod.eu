...
heihei/index.html: heihei/index.org
	pandoc -s --shift-heading-level-by=1 --from=org+smart -i heihei/index.org -t json | ./play.clj filter resolve-links | pandoc -f json -o heihei/index.html --standalone --toc -H header-default-include.html

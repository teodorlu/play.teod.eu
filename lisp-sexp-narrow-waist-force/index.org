...
To me, right now, the title sums it all up.
Working with S-expressions takes discipline.
It's not easy, you can't just write words and lean on your brain's natural language center to get it all done.
...
Digression: I do /not/ dislike MATLAB, Jupyter notebooks or Julia.

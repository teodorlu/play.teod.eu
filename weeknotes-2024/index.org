...
4. I've been thinking too much top down.
   ...
   *do: represent your core as data, work in the REPL*.
   What is your core?
   ...
   *don't: write long functions that do too much*.
   Those functions can't be tested.
   Split up your code, and it will help you.

   *don't: arbitrarily split your implementation into multiple pieces*.

...
list-of-problems/index.html: list-of-problems/index.org
	pandoc -s --shift-heading-level-by=1 --from=org+smart -i list-of-problems/index.org -t json | ./play.clj filter resolve-links | pandoc -f json -o list-of-problems/index.html --standalone --toc -H header-default-include.html
